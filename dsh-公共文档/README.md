...
The product baseline remains in `../Kimi_Agent_DeepSeek Harness 移动端/`. Where an implementation detail was not specified there, the API and protocol documents in this directory make the MVP decision explicit.
